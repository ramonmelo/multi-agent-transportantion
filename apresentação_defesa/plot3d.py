...
# ax.add_artist(a)
# ax.text(0, 0, 1, "up", size=20)

# a = Arrow3D([0,0],[0,0],[0,-1], mutation_scale=20, lw=1, arrowstyle="-|>", color="k")
# ax.add_artist(a)
# ax.text(0, 0, -1.1, "down", size=20)

a = Arrow3D([0,1],[0,0],[0,0], mutation_scale=20, lw=1, arrowstyle="-|>", color="k")
ax.add_artist(a)
ax.text(0.7, 0, 0.1, "backward", size=20)

a = Arrow3D([0,0],[0,1],[0,0], mutation_scale=20, lw=1, arrowstyle="-|>", color="k")
ax.add_artist(a)
ax.text(0, 1, 0.1, "left", size=20)

a = Arrow3D([0,-1],[0,0],[0,0], mutation_scale=20, lw=1, arrowstyle="-|>", color="k")
ax.add_artist(a)
ax.text(-1, 0, -0.1, "forward", size=20)

a = Arrow3D([0,0],[0,-1],[0,0], mutation_scale=20, lw=1, arrowstyle="-|>", color="k")
ax.add_artist(a)
ax.text(0.1, -1, 0, "right", size=20)
